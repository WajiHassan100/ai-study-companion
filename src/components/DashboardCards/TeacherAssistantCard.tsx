...
export function TeacherAssistantCard() {
  ...
  const handleGenerateLessonPlan = async () => {
    ...
    try {
      ...
      setLessonPlan(data);
      toast.success("Lesson plan generated by Agent #6!");
    } catch (err) {
  ...
  const handleGradeSubmission = async () => {
    ...
    try {
      ...
      toast.success("Submission auto-graded by Agent #6!");
    } catch (err) {
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <CardTitle className="font-display text-lg font-bold text-foreground">
              Agent #6: Teacher Assistant Studio
            </CardTitle>
        ...
        <Tabs defaultValue="lesson">
          ...
          <TabsContent value="quiz" className="space-y-4">
            ...
            >
              ...
              <span>{loadingQuiz ? "Generating Quiz..." : "Publish Quiz to Class (Agent #4)"}</span>
            </Button>
